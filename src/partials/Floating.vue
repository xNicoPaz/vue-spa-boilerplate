<template>
	<v-dialog v-model="sharedData.dialog" width="800px">
		<v-card>
			...
			<v-card-actions>
				...
				<v-spacer></v-spacer>
				<v-btn flat color="primary" @click="sharedData.dialog = false">Cancel</v-btn>
				<v-btn flat @click="sharedData.dialog = false">Save</v-btn>
			</v-card-actions>
		</v-card>
	</v-dialog>
</template>
